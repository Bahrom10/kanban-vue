<template>
    <nav class="nav items-center flex justify-between p-4 bg-gray-600 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
        ...
        <div class="flex items-center gap-2">
            <input class="border-2 border-gray-400 text-gray-400 rounded-md p-2 pl-8 outline-0 placeholder-gray-400" type="text" v-model="search" @change="$emit('searchQuery', search)" placeholder="Search tasks..." style="background: url('./search.svg') no-repeat scroll 8px 11.6px;"/>
